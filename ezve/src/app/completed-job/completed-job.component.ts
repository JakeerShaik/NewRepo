...
export class CompletedJobComponent implements OnInit {
  ...
  constructor(private history:HistoryService,
    private outstandingjob:OutstandingjobService,
...
{
  this.outstandingjob.getAllCompletedJob().
  subscribe(allCompletedJob => {
//console.log(allCompletedJob.jobCreation)

if(allCompletedJob.jobCreation)
    {
     this. rowData=allCompletedJob.jobCreation
    }
  })
}
